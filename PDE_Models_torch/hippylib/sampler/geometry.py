...
class Geometry:
    ...
    def get_geom(self, parameter=None, geom_ord=[0], whitened=True, **kwargs): #log_level=dl.ERROR
        ...
        if any(s >= 1.5 for s in geom_ord):
            ...
            HessApply = ReducedHessian(self.model, misfit_only=kwargs.pop('MF_only', True))
