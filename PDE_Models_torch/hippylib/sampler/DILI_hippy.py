...
#             w=sp.linalg.eig(A,b=B,left=False,right=False)
    ...
    def setup(self,num_samp=1000,num_burnin=100,prt_lvl=1,#mpi_comm=dl.mpi_comm_world(),
        seed=2017,**kwargs):
        """
        ...
        # self.mpi_comm = self.model.problem.model.mesh.mpi_comm()
    ...
    def adaptive_MCMC(self,num_retry_bad=0,**kwargs):
        ...
        for n in range(self.parameters['number_of_samples']+self.parameters['number_of_burnins']):
